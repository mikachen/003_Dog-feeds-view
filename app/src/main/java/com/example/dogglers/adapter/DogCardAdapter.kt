...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
        ...
        val textView1: TextView = view!!.findViewById(R.id.dog_context_name)
        val textView2: TextView = view!!.findViewById(R.id.dog_context_age)
        val textView3: TextView = view!!.findViewById(R.id.dog_context_hobbies)
